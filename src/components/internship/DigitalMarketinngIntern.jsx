  ...
  Digital: [
    {
      ...
      description:
        "Crafted by industry experts, this dynamic program establishes a strong foundation in SEO, social media marketing, content strategy, and data-driven campaign optimization. Whether you're a beginner or a marketing professional aiming to refine your skills, this training integrates cutting-edge tools and real-world case studies to empower you with the expertise needed to craft impactful digital strategies and drive measurable business growth.",
...
const DigitalMarketinngIntern = () => {
  const course = sections.Digital[0];
  return (
...
export default DigitalMarketinngIntern;
