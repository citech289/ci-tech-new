  ...
  Powerbi: [
    {
      ...
      description:
        "Designed by industry experts, this immersive program establishes a strong foundation in business intelligence (BI), data visualization, and dashboard development. Whether you're a beginner or an aspiring analyst, this training equips you with hands-on experience in leading BI tools and techniques, empowering you to transform raw data into actionable insights for data-driven decision-making.",
      image: "/BI.png",
      modules: [
        "Phase 1: Power BI Setup & Data Loading",
        "Phase 2:  Data Modeling & Basic Visuals",
        "Phase 3: DAX Essentials",
        "Phase 4: Advanced Visuals & User Interactions",
        "Phase 5: AI Visuals & Data Storytelling",
        "Phase 6: Publishing, Power BI Service & Governance",
...
const PowerBi = () => {
  const course = sections.Powerbi[0];
  return (
    <div className="mt-30 px-6 flex flex-col gap-8 p-4">
      ...
      <div className="flex flex-col md:flex-row items-start relative">
        ...
        <div className="flex items-center mt-4 md:mt-40 lg:mt-22 md:w-1/3">
